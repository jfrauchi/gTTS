...
@click.command()
@click.option("-w", "--words", help="Enter a string you want to convert to an audio file")
@click.option("-f", "--filename", help="Enter file path to text file you want to convert to an audio file")
